function varargout = odorGUI_jacob(varargin)
% ODORGUI_JACOB MATLAB code for odorGUI_jacob.fig
%      ODORGUI_JACOB, by itself, creates a new ODORGUI_JACOB or raises the existing
%      singleton*.
%
%      H = ODORGUI_JACOB returns the handle to a new ODORGUI_JACOB or the handle to
%      the existing singleton*.
%
%      ODORGUI_JACOB('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ODORGUI_JACOB.M with the given input arguments.
%
%      ODORGUI_JACOB('Property','Value',...) creates a new ODORGUI_JACOB or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before odorGUI_jacob_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to odorGUI_jacob_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help odorGUI_jacob

% Last Modified by GUIDE v2.5 07-Dec-2016 14:58:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @odorGUI_jacob_OpeningFcn, ...
                   'gui_OutputFcn',  @odorGUI_jacob_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before odorGUI_jacob is made visible.
function odorGUI_jacob_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to odorGUI_jacob (see VARARGIN)

% Choose default command line output for odorGUI_jacob
...
handles.log_file_name = 'Orco-GCaMP6_run101';
...
% UIWAIT makes odorGUI_jacob wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = odorGUI_jacob_OutputFcn(hObject, eventdata, handles) 
...
elseif handles.channel_number == 16
    ...
    handles.conc_list=cell(13,1);
    handles.odor_list=cell(13,1);
...
% --- Executes on selection change in concentration N.
...
idx=strfind(handles.log_file_name,'_run')+4;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    idx=strfind(handles.fileName.String,'_run');
    if isempty(idx)
        newrunnum=101;
...
% --- Executes on selection change in popupmenu134.
function popupmenu134_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu134 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu134 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu134


% --- Executes during object creation, after setting all properties.
function popupmenu134_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu134 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu135.
function popupmenu135_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu135 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu135 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu135


% --- Executes during object creation, after setting all properties.
function popupmenu135_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu135 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu136.
function popupmenu136_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu136 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu136 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu136


% --- Executes during object creation, after setting all properties.
function popupmenu136_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu136 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu137.
function popupmenu137_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu137 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu137 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu137


% --- Executes during object creation, after setting all properties.
function popupmenu137_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu137 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu138.
function popupmenu138_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu138 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu138 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu138


% --- Executes during object creation, after setting all properties.
function popupmenu138_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu138 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu139.
function popupmenu139_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu139 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu139 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu139


% --- Executes during object creation, after setting all properties.
function popupmenu139_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu139 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu140.
function popupmenu140_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu140 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu140 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu140


% --- Executes during object creation, after setting all properties.
function popupmenu140_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu140 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu141.
function popupmenu141_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu141 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu141 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu141


% --- Executes during object creation, after setting all properties.
function popupmenu141_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu141 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu142.
function popupmenu142_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu142 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu142 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu142


% --- Executes during object creation, after setting all properties.
function popupmenu142_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu142 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu143.
function popupmenu143_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu143 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu143 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu143


% --- Executes during object creation, after setting all properties.
function popupmenu143_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu143 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu144.
function popupmenu144_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu144 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu144 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu144


% --- Executes during object creation, after setting all properties.
function popupmenu144_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu144 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu145.
function popupmenu145_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu145 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu145 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu145


% --- Executes during object creation, after setting all properties.
function popupmenu145_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu145 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu146.
function popupmenu146_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu146 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu146 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu146


% --- Executes during object creation, after setting all properties.
function popupmenu146_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu146 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu147.
function popupmenu147_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu147 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu147 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu147


% --- Executes during object creation, after setting all properties.
function popupmenu147_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu147 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu148.
function popupmenu148_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu148 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu148 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu148


% --- Executes during object creation, after setting all properties.
function popupmenu148_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu148 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu149.
function popupmenu149_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu149 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu149 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu149


% --- Executes during object creation, after setting all properties.
function popupmenu149_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu149 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu150.
function popupmenu150_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu150 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu150 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu150


% --- Executes during object creation, after setting all properties.
function popupmenu150_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu150 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu151.
function popupmenu151_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu151 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu151 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu151


% --- Executes during object creation, after setting all properties.
function popupmenu151_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu151 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu152.
function popupmenu152_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu152 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu152 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu152


% --- Executes during object creation, after setting all properties.
function popupmenu152_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu152 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu153.
function popupmenu153_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu153 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu153 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu153


% --- Executes during object creation, after setting all properties.
function popupmenu153_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu153 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu154.
function popupmenu154_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu154 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu154 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu154


% --- Executes during object creation, after setting all properties.
function popupmenu154_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu154 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu155.
function popupmenu155_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu155 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu155 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu155


% --- Executes during object creation, after setting all properties.
function popupmenu155_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu155 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu156.
function popupmenu156_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu156 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu156 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu156


% --- Executes during object creation, after setting all properties.
function popupmenu156_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu156 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in popupmenu157.
function popupmenu157_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu157 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu157 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu157


% --- Executes during object creation, after setting all properties.
function popupmenu157_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu157 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
