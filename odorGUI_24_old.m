...
% Last Modified by GUIDE v2.5 09-Dec-2016 12:42:55
...
handles.channel_string = [{'A1'}; {'A2'}; {'A3'}; {'A4'}; {'A5'}; {'A6'}; {'A7'}; {'A8'};...
    {'B1'}; {'B2'}; {'B3'}; {'B4'}; {'B5'}; {'B6'}; {'B7'}; {'B8'}; {'C1'}; {'C2'}; {'C3'}; {'C4'}; {'C5'};...
    {'C6'}; {'C7'}; {'C8'}];
...
% --- Executes on selection change in popupmenu168.
function popupmenu168_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu168 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu168 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu168
...
% --- Executes on selection change in popupmenu169.
function popupmenu169_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu169 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu169 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu169
